...
class PSPNet(BaseModel):
    def __init__(self, num_classes, in_channels=3, backbone='resnet34', pretrained=True, use_aux=True, freeze_bn=False, freeze_backbone=False):
